...
function updateRebateRate() {
    return __awaiter(this, void 0, void 0, function () {
        var transaction, committedTransaction, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, aptos.transaction.build.simple({
                        sender: singer.accountAddress,
                        data: {
                            function: "".concat(moduleAddress, "::market::update_rebate_rate"),
                            typeArguments: [],
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, updateRebateRate()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
