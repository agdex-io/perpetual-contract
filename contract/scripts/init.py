...
contract_address = "0xd7b83a04de1c2dd514f7a5b452b2b20649ede6c0f4e0181c82ec1c154c7f185c"
...
async def main():
    ...
    # txn_hash = await rest_client.add_acl(
    #     sender,
    #     list(
    #         bytes.fromhex(
    #             "0xd7b83a04de1c2dd514f7a5b452b2b20649ede6c0f4e0181c82ec1c154c7f185c"
    #         )
    #     ),
    # )

    #  "0x1::aptos_coin::AptosCoin" | "44a93dddd8effa54ea51076c4e851b6cbbfd938e82eb90197de38fe8876bb66e"
    #  "0x6f60af74988c64cd3b7c1e214697e6949db39c061d8d4cf59a7e2bd1b66c8bf0::usdc::USDC" | "41f3625971ca2ed2263e78573fe5ce23e13d2558ed3f2e47ab0f84fb9e7ae722"
    #  "0x6f60af74988c64cd3b7c1e214697e6949db39c061d8d4cf59a7e2bd1b66c8bf0::usdt::USDT" | "1fc18861232290221461220bd4e2acd1dcdfbc89c84092c93c18bdc7756c1588"
    ################## FUNCTION START
    # txn_hash = await rest_client.add_new_vault(
    #     sender,
    ...
    # "0x1::aptos_coin::AptosCoin" | "44a93dddd8effa54ea51076c4e851b6cbbfd938e82eb90197de38fe8876bb66e"
    # "0x6f60af74988c64cd3b7c1e214697e6949db39c061d8d4cf59a7e2bd1b66c8bf0::btc::BTC" | "f9c0172ba10dfa4d19088d94f5bf61d3b54d5bd7483a322a982e1373ee8ea31b"
    # "0x6f60af74988c64cd3b7c1e214697e6949db39c061d8d4cf59a7e2bd1b66c8bf0::ETH::ETH" | "ca80ba6dc32e08d06f1aa886011eed1d77c77be9eb761cc10d72b7d0a2fd57a6"
    ################## FUNCTION START
    # txn_hash = await rest_client.add_new_symbol(
    #     sender,
    #     "0x6f60af74988c64cd3b7c1e214697e6949db39c061d8d4cf59a7e2bd1b66c8bf0::ETH::ETH",
    #     "SHORT",
    #     2000,
    #     18446744073709551615,
    #     list(
    ...
    #         )
    #     ),
    #     20000000000000000,  # param_multiplier
    #     7500000000000000,  # param_max
    #     100,  # max_leverage
    #     20,
    #     100,  # max_reserved_multiplier
    #     500000000000000,  # min_collateral_value
    ...
    # "0x1::aptos_coin::AptosCoin"
    # "0x6f60af74988c64cd3b7c1e214697e6949db39c061d8d4cf59a7e2bd1b66c8bf0::ETH::ETH"
    # "0x6f60af74988c64cd3b7c1e214697e6949db39c061d8d4cf59a7e2bd1b66c8bf0::btc::BTC"
    ...
    # txn_hash = await rest_client.add_collateral_to_symbol(  # collater index direction
    #     sender,
    #     "0x6f60af74988c64cd3b7c1e214697e6949db39c061d8d4cf59a7e2bd1b66c8bf0::usdt::USDT",
    #     "0x6f60af74988c64cd3b7c1e214697e6949db39c061d8d4cf59a7e2bd1b66c8bf0::btc::BTC",
    #     "SHORT",
    ...
    # txn_hash = await rest_client.add_collateral_to_symbol(
    #     sender,
    #     "0x6f60af74988c64cd3b7c1e214697e6949db39c061d8d4cf59a7e2bd1b66c8bf0::usdc::USDC",
    #     "0x6f60af74988c64cd3b7c1e214697e6949db39c061d8d4cf59a7e2bd1b66c8bf0::btc::BTC",
    #     "SHORT",
    ...
    #     "SHORT",
    # )
    # txn_hash = await rest_client.deposit(
    #     sender, "0x1::aptos_coin::AptosCoin", 100000000, 0
    # )
    # txn_hash = await rest_client.withdraw(
    #     sender, "0x1::aptos_coin::AptosCoin", 6000000, 0
    # )
    ...
    #     0,
    # )
    # txn_hash = await rest_client.pledge_in_position(
    #     sender,
    #     "0x1::aptos_coin::AptosCoin",
    #     "0x1::aptos_coin::AptosCoin",
    #     "LONG",
