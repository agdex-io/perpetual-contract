...
# add admin to acl
#add_admin=`aptos move run --function-id 0x8916cdadc2d1097eb278ad02193089a604909c65849d6bfaeb7fce87acba1677::admin::add_acl --args 'address:["0x8916cdadc2d1097eb278ad02193089a604909c65849d6bfaeb7fce87acba1677"]' --assume-yes`
#echo "$add_admin"
