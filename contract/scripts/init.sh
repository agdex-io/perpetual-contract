...
# add admin to acl
#add_admin=`aptos move run --function-id 0x5820ab6b148870afb4ce70569df5dd4442050d7d501778bcc282d2d4c45e948c::admin::add_acl --args 'address:["0x5820ab6b148870afb4ce70569df5dd4442050d7d501778bcc282d2d4c45e948c"]' --assume-yes`
#echo "$add_admin"
