...
# add admin to acl
add_admin=`movement move run --function-id 0x74bd2f63f61199da6b79f3bf478cea1ae7543dbf1c6bff1176ab9ff86aa271e1::admin::add_acl --args 'address:["0x74bd2f63f61199da6b79f3bf478cea1ae7543dbf1c6bff1176ab9ff86aa271e1"]' --assume-yes`
echo "$add_admin"
