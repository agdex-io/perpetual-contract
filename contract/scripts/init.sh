...
# add admin to acl
#add_admin=`aptos move run --function-id 0x7fe5afe849218e50eabf21ecbd472803013607c17e97458d48d587f5cbc96b53::admin::add_acl --args 'address:["0x7fe5afe849218e50eabf21ecbd472803013607c17e97458d48d587f5cbc96b53"]' --assume-yes`
#echo "$add_admin"
